...
export default function IssuedBooksClient({ canManage }: { canManage: boolean }) {
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-0.5 text-[13.5px] text-slate-500">
          {canManage ? "Issue a book to a member, or process a return." : "A record of your library loans."}
        </p>
      </div>
      ...
      <Card>
        ...
        <div className="-mx-[18px] overflow-x-auto px-[18px]">
          <table className="w-full min-w-[620px] border-collapse text-[13px]">
            <thead>
              <tr>
                {["Book", "Member", "Issued", "Due", "Status", ...(canManage ? [""] : [])].map(h => (
